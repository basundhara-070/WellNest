...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-blue-50 to-cyan-50 text-gray-800 py-8 mt-16">
      <div className="container mx-auto px-4">
        {/* Footer Content */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Brand Information */}
          <div className="text-center md:text-left">
            <h3 className="text-xl font-semibold mb-4">WellNest</h3>
            <p className="text-sm">
          ...
          <div className="text-center">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/tests" className="hover:text-blue-500 transition duration-300">
                  Tests
                </a>
              </li>
              <li>
